...
from app.core.retriever_user import build_user_block, get_user_context  # type: ignore # noqa
...
def test_build_user_block_full():
    ...
    ctx = {"job_role": "AI Engineer", "technologies": ["PyTorch", "NLP"], "location": "HCM", "bio": "Exp"}
