...
def test_build_feature_matrix_includes_skill_jaccard_and_article_temporal_blocks(
    dummy_data, mock_feature_params
):
    ...
    X, meta = build_feature_matrix(
        df_tech, gds, emb, stats, None, None, mock_feature_params,
        skill_jaccard=skill_jaccard, article_temporal=article_temporal,
    )
...
def test_build_feature_matrix_skips_new_blocks_when_disabled(dummy_data, mock_feature_params):
    ...
    X, meta = build_feature_matrix(
        df_tech, gds, emb, stats, None, None, mock_feature_params,
        skill_jaccard=skill_jaccard, article_temporal=None,
    )
