...
def create_scheduler(settings: Settings) -> BackgroundScheduler:
    ...
    logger.info(
        ...
        settings.article_sync_hour,
        settings.article_sync_minute,
        settings.gold_etl_hour,
        settings.gold_etl_minute,
        settings.neo4j_enricher_hour,
        settings.neo4j_enricher_minute,
        settings.embed_trigger_hour,
        settings.embed_trigger_minute,
        settings.clustering_retrain_day_of_week,
        settings.clustering_retrain_hour,
        settings.clustering_retrain_minute,
    )
