...
interface CareerSimulatorProps {
    suggestions?: string[];
    onSimulate: (technology: string) => Promise<CareerSimulationResult>;
}
 ...
 */
export default function CareerSimulator({ suggestions = [], onSimulate }: CareerSimulatorProps) {
    const [technology, setTechnology] = useState('');
    const [result, setResult] = useState<CareerSimulationResult | null>(null);
