...
import type { TaggedCompany } from '../../types/social';
import './CompanyTagPicker.css';

interface CompanyTagPickerProps {
    selected: TaggedCompany | null;
    onSelect: (company: Company) => void;
    onClear: () => void;
}

/** Composer control to tag a post with a company, searched from the existing /companies list. */
export default function CompanyTagPicker({ selected, onSelect, onClear }: CompanyTagPickerProps) {
