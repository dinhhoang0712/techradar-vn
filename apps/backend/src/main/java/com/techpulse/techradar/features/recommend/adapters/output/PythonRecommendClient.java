package com.techpulse.techradar.features.recommend.adapters.output;
...
public class PythonRecommendClient implements RecommendServicePort {
    ...
    @Override
    public Mono<Map<String, Object>> getRecommendations(Map<String, Object> request) {
        return webClient()
                .post()
                .uri("/recommend")
                ...
                .onErrorResume(ex -> {
                    log.error("Recommend service error", ex);
                    return Mono.error(new DatabaseUnavailableException("Recommendation service unavailable"));
                });
    }
}
