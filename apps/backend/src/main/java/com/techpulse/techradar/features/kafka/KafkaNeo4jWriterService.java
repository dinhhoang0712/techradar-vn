...
public class KafkaNeo4jWriterService {
    ...
    private final Neo4jExtractionWriter neo4jWriter;
    ...
    public KafkaNeo4jWriterService(ObjectMapper objectMapper, Neo4jExtractionWriter neo4jWriter, KafkaProducerService kafkaProducer) {
