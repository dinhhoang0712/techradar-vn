package com.techpulse.techradar.features.career.adapters.output;
...
public class PythonCareerClient implements CareerServicePort {
    ...
    @Override
    public Mono<Map<String, Object>> getCareerAdvice(Map<String, Object> request) {
        return webClient()
                .post()
                .uri("/career")
                ...
                .onErrorResume(ex -> {
                    log.error("Career service error", ex);
                    return Mono.error(new DatabaseUnavailableException("Career service unavailable"));
                });
    }
}
